package com.gapprint.ilikegap.ui.home.newproduk.adapter;
...
public class AdapterNewProduct extends RecyclerView.Adapter<AdapterNewProduct.ViewHolder> {
    ...
    Context context;
    ArrayList<ModelNewProduk> rvdatacommentArrayList;


    //


    public AdapterNewProduct(Context context, ArrayList<ModelNewProduk> rvdatacommentArrayList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        final ModelNewProduk rvdatanewproduk = rvdatacommentArrayList.get(position);
