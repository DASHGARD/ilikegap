...
public class AdapterProductSerupa extends RecyclerView.Adapter<AdapterProductSerupa.ViewHolder> {

    Context context;
    ArrayList<ModelProdukserupa> rvdatacommentArrayList;
    ...
    public AdapterProductSerupa(Context context, ArrayList<ModelProdukserupa> rvdatacommentArrayList) {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        final ModelProdukserupa rvdatanewproduk = rvdatacommentArrayList.get(position);
